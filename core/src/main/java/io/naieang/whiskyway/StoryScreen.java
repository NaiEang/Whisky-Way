...
public class StoryScreen implements Screen {
    ...
    public void render(float delta) {
        ...
        font.getData().setScale(2f);
            font.draw(batch, 
        "Meet Leo, a hardworking university student in the bustling town of Whisky Way towngit a.\n" +
        ...
        50, Gdx.graphics.getHeight() - 50, Gdx.graphics.getWidth() - 100, 1, true);
        ...
        if (Gdx.input.isKeyJustPressed(com.badlogic.gdx.Input.Keys.ENTER)) {
            game.setScreen(new GameScreen()); // Go to your GameScreen
